    ...
    <>
      ...
      >
        <Box maxW="90%" m="auto" p="3.5rem 0" minH="500px" w="100vw" zIndex="1">
          <Box w={["100%", "50%"]} m="auto">
            <Box mb="3.5rem" id="coffee" scrollMarginTop="96px">
              <Box
                display="flex"
                flexDir="row"
                justifyContent="left"
            ...
            <Box mb="3.5rem" id="specialty" scrollMarginTop="96px">
              <Box
                display="flex"
                flexDir="row"
                justifyContent="left"
            ...
            <Box mb="3.5rem" id="boba" scrollMarginTop="96px">
              <Box
                display="flex"
                flexDir="row"
                justifyContent="left"
            ...
            <Box mb="3.5rem" id="hot-bites" scrollMarginTop="96px">
              <Box
                display="flex"
                flexDir="row"
                justifyContent="left"
            ...
            <Box mb="3.5rem" id="sandwiches" scrollMarginTop="96px">
              <Box
                display="flex"
                flexDir="row"
                justifyContent="left"
                ...
                <Box display="flex" flexDir="column" w="-webkit-fill-available">
                  <Box mb="1rem">
                    ...
                    <Text as="i">
                      ...
                      lettuce, onion and avocado. ​Comes with a side of our
                      house made chipotle aioli and chips
                    </Text>
                  </Box>
                  <Box mb="1rem">
                    <Text fontWeight="700" fontFamily="heading">
            ...
            <Box mb="3.5rem" id="seasonal" scrollMarginTop="96px">
              <Box
                display="flex"
                flexDir="row"
                justifyContent="left"
            ...
            <Box mb="3.5rem" id="beer-wine" scrollMarginTop="96px">
              <Box
                display="flex"
                flexDir="row"
                justifyContent="left"
