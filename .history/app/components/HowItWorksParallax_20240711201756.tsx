  ...
  return (
    <>
      ...
      >
        ...
        <Box data-speed="0.05" position="absolute" top="15%" right="15%">
          <Image
        ...
        <Box data-speed="0.1" position="absolute" top="18%" right="11%">
          <Image
            src="./images/dollarsign.png"
            maxW="100px"
            alt="Parallax Image 1"
        ...
        <Box data-speed="0.3" position="absolute" top="40%" left="40%">
          <Image src="./images/board-games.png" alt="Parallax Image 2" />
        </Box>
