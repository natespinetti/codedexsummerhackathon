      ...
      >
        <Box maxW="90%" m="auto" p="3.5rem 0" minH="500px">
          ...
          <Text>
            ...
            for this event. ​ *Top 8 Prizing subject to change if event has less
            than 32 players Example prizing for 32 attendees: 1st) $250 Travel
            Stipend + foil Goblin Guide + non-foil Goblin Guide + Regional
            Championship invitation 2nd) $200 store credit + non-foil Goblin
            Guide 3rd and 4th) $125 store credit + non-foil Goblin Guide
            5th-8th) $75 store credit + non-foil Goblin Guide Pre-register here!
            https://square.link/u/ZxuZohAV
          </Text>
          <Text>
            Players who make top 8 will receive prizes in store credit and
            promos, and the first 32 registrants will receive a Springleaf Drum
            participation promo! Specific prizing structure to be determined
            based on attendance.
          </Text>
          <Text>
          ...
          <Text>Example prizing for 32 attendees:</Text>
          <Box display="grid" gridTemplateColumns="100px auto" gridGap=".5rem">
            <Text fontWeight="600">1st)</Text>
            <Text>
              $250 Travel Stipend + foil Goblin Guide + non-foil Goblin Guide +
              Regional Championship invitation
            </Text>
          </Box>
          <Box display="flex" flexDir="row" gridGap=".5rem">
            <Text fontWeight="600">2nd)</Text>
            <Text>$200 store credit + non-foil Goblin Guide</Text>
          </Box>
          <Box display="flex" flexDir="row" gridGap=".5rem">
            <Text fontWeight="600">3rd-4th)</Text>
            <Text>$125 store credit + non-foil Goblin Guide</Text>
          </Box>
          <Box display="flex" flexDir="row" gridGap=".5rem">
            <Text fontWeight="600">5th-8th)</Text>
