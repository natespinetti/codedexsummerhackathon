    ...
    <>
      ...
      >
        <Box maxW="90%" m="auto" p="2.5rem 0">
          ...
          <Box w="70%" mr="auto" m="auto" mt="4rem">
        ...
        <Box data-speed="0.1" position="absolute" top="8%" right="15%">
          <Image
        ...
        <Box data-speed="0.2" position="absolute" top="10%" right="10%">
          <Image
            src="./images/dollarsign.png"
            maxW="150px"
            alt="Parallax Image 1"
