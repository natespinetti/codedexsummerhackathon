...
import { Box, Text, Button, keyframes, ListItem, List } from "@chakra-ui/react";
      ...
      <Box bg="var(--chakra-colors-gray-50)">
        <Box maxW="90%" m="auto" p="2.5rem 0">
          ...
          <List as="ul">
            ...
            <ListItem>$10 per person for 3 hours during the week</ListItem>
            <ListItem>
              $12 per person for 3 hours on weekends and holidays
            </ListItem>
            <ListItem>
